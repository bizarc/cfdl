      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center gap-6 px-4 sm:px-6">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="CFDL on GitHub"
            className="inline-flex h-9 w-9 items-center justify-center rounded-md text-secondary transition-colors hover:bg-surface-sunken hover:text-primary"
          >
            <GithubMark />
          </a>
          <ThemeToggle />
