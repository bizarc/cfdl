...
- [CRE: mixed-use development with a construction facility](/docs/examples/cre-penzance-highlands) — A 160-month ground-up CRE development: land in 2011, a 39-month build on a parabolic draw curve, a $380M facility that funds equity first and capitalizes interest, two rental towers sold in lease-up, and a 34-month condominium sellout.
