...
contract energy.ppa on entity project.plant {
...
contract energy.om.fixed on entity project.plant {
  term 2026-01..2050-01
  terms {
    om_year    = 13000
    escalation = 0.016
...
contract energy.om.insurance on entity project.plant {
  term 2026-01..2050-01
  terms {
    om_year    = 28000
    escalation = 0.016
...
// Land lease.
contract energy.om.land_lease on entity project.plant {
  term 2026-01..2050-01
  terms {
    om_year    = 5000
    escalation = 0.016
...
contract energy.om.pilot on entity project.plant {
  term 2026-01..2050-01
  terms {
    om_year    = 50000
    escalation = -0.1
...
// ---------------------------------------------------------------------------
stream energy.royalty.expense on entity project.plant outflow currency USD {
...
contract energy.debt_service on entity project.plant {
