...
stream opco.ufcf.stub_2024 on entity legal.target inflow currency USD {
  schedule every month mid from 2024-08 to 2024-08
  category operating.revenue.recurring
  amount = 135.51
}

stream opco.ufcf.fy2025 on entity legal.target inflow currency USD {
  schedule every month from 2025-06 to 2025-06
  category operating.revenue.recurring
  amount = 392
}

stream opco.ufcf.fy2026 on entity legal.target inflow currency USD {
  schedule every month from 2026-06 to 2026-06
  category operating.revenue.recurring
  amount = 448
}

stream opco.ufcf.fy2027 on entity legal.target inflow currency USD {
  schedule every month from 2027-06 to 2027-06
  category operating.revenue.recurring
  amount = 527
}

stream opco.ufcf.fy2028 on entity legal.target inflow currency USD {
...
stream opco.sbc.fy2025 on entity legal.target outflow currency USD {
  schedule every month from 2025-06 to 2025-06
  category operating.expense.opex
  amount = 166
}

stream opco.sbc.fy2026 on entity legal.target outflow currency USD {
  schedule every month from 2026-06 to 2026-06
  category operating.expense.opex
  amount = 180
}

stream opco.sbc.fy2027 on entity legal.target outflow currency USD {
  schedule every month from 2027-06 to 2027-06
  category operating.expense.opex
  amount = 190
}

stream opco.sbc.fy2028 on entity legal.target outflow currency USD {
  schedule every month from 2028-06 to 2028-06
  category operating.expense.opex
  amount = 193
}
