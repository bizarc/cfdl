...
| Code | Family | Meaning |
|---|---|---|
| `E0001_UNEXPECTED_TOKEN` | Parse errors |  |
| `E0002_UNTERMINATED_STRING` | Parse errors |  |
| `E0003_UNTERMINATED_BLOCK_COMMENT` | Parse errors |  |
| `E0004_EXPECTED_TOKEN` | Parse errors |  |
| `E0005_INVALID_DATE_LITERAL` | Parse errors |  |
| `E1201_IMPORT_CYCLE` | Module/import |  |
| `E1202_IMPORT_NOT_FOUND` | Module/import |  |
| `E1203_IMPORT_OUTSIDE_MODEL_ROOT` | Module/import |  |
| `E1101_MISSING_VERSION` | Global structure |  |
| `E1102_MISSING_MODEL` | Global structure |  |
| `E1103_MISSING_TIME` | Global structure |  |
| `E1104_MULTIPLE_VERSION` | Global structure |  |
| `E1105_MULTIPLE_MODEL` | Global structure |  |
| `E1106_MULTIPLE_TIME` | Global structure |  |
| `E1107_MULTIPLE_USE_PACK` | Global structure |  |
| `E1108_USE_PACK_NOT_IN_MODEL_FILE` | Global structure |  |
| `E1109_MISSING_ENTITY` | Global structure |  |
...
| `E1001_DUPLICATE_ENTITY` | Symbols and references |  |
| `E1002_DUPLICATE_CONTRACT` | Symbols and references |  |
| `E1003_DUPLICATE_STREAM` | Symbols and references |  |
| `E1004_DUPLICATE_PHASE` | Symbols and references |  |
| `E1005_DUPLICATE_ASSUME` | Symbols and references |  |
| `E1006_DUPLICATE_OPTION` | Symbols and references |  |
| `E1007_DUPLICATE_EVENT` | Symbols and references |  |
| `E1301_UNRESOLVED_ENTITY_REF` | Symbols and references |  |
| `E1302_UNRESOLVED_STREAM_REF` | Symbols and references |  |
| `E1303_UNRESOLVED_CONTRACT_REF` | Symbols and references |  |
| `E1304_UNRESOLVED_OPTION_REF` | Symbols and references |  |
| `E1305_UNRESOLVED_PHASE_REF` | Symbols and references |  |
...
| `E2001_CONTRACT_MISSING_TERM` | Contracts and streams |  |
| `E2002_CONTRACT_MISSING_EFFECTS` | Contracts and streams |  |
| `E2003_CONTRACT_CURRENCY_REQUIRED` | Contracts and streams |  |
| `E2101_STREAM_MISSING_SCHEDULE` | Contracts and streams |  |
| `E2102_STREAM_MISSING_AMOUNT` | Contracts and streams |  |
...
| `E2104_SCHEDULE_INVALID_RANGE` | Contracts and streams |  |
| `E2105_SCHEDULE_INVALID_DAY_OF_MONTH` | Contracts and streams |  |
| `E2106_SCHEDULE_PHASE_NOT_FOUND` | Contracts and streams |  |
...
| `E2201_EVENT_WHEN_NOT_BOOL` | Events and actions |  |
| `E2202_STREAM_ACTIVE_NOT_BOOL` | Events and actions |  |
| `E2203_ACTION_SET_FIELD_INVALID` | Events and actions |  |
| `E3001_EXPR_PARSE_ERROR` | Expressions / typing |  |
| `E3002_EXPR_UNKNOWN_IDENT` | Expressions / typing |  |
| `E3003_EXPR_TYPE_ERROR` | Expressions / typing |  |
| `E3004_EXPR_ILLEGAL_OP` | Expressions / typing |  |
| `W3001_EXPR_TYPE_UNKNOWN` | Expressions / typing |  |
| `W3002_OBS_REF_EXTRACTION_FAILED` | Expressions / typing |  |
| `E4001_UNKNOWN_TYPE_ID` | Pack errors |  |
| `E4002_INVALID_ENTITY_ATTR` | Pack errors |  |
| `E4003_INVALID_CONTRACT_TERMS` | Pack errors |  |
| `E4004_MISSING_PACK` | Pack errors |  |
| `E5001_ID_GENERATION_FAILED` | Lowering/emission |  |
| `E5002_IR_SCHEMA_VALIDATION_FAILED` | Lowering/emission |  |
| `E5003_IR_EMIT_FAILED` | Lowering/emission |  |
| `E5004_INVALID_LOWERING_RULE` | Lowering/emission |  |
| `E5005_PHASE_NOT_FOUND` | Lowering/emission |  |
| `E5006_MISSING_CONTRACT_TERM` | Lowering/emission |  |
| `E5007_DUPLICATE_LOWERED_STREAM` | Lowering/emission |  |
