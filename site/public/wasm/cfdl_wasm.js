 ...
 * @returns {string}
 */
export function compile(files_json, root_file) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(files_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(root_file, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function compile_and_run(files_json, root_file, config_json, pack) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(files_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        var ptr3 = isLikeNone(pack) ? 0 : passStringToWasm0(pack, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len3 = WASM_VECTOR_LEN;
        const ret = wasm.compile_and_run(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        deferred5_0 = ret[0];
        deferred5_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function run(ir_json, config_json, pack) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        var ptr2 = isLikeNone(pack) ? 0 : passStringToWasm0(pack, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cfdl_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
