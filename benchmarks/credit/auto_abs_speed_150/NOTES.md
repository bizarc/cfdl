# Auto ABS collateral at 1.50% ABS
...
`auto_abs_wal` takes the zero-speed column. This case takes the 1.50% column.
...
|---|---|---|---|
| 10/15/18 | 74.816 | 74.82 | -0.0036 |
| 11/15/18 | 50.328 | 50.33 | -0.0023 |
| 12/15/18 | 26.538 | 26.54 | -0.0018 |
| 01/15/19 | 3.452 | 3.45 | +0.0023 |
| 02/15/19 | 0.000 | 0.00 | +0.0000 |
| 03/15/19 | 0.000 | 0.00 | +0.0000 |
| 04/15/19 | 0.000 | 0.00 | +0.0000 |
| 05/15/19 | 0.000 | 0.00 | +0.0000 |

**Worst disagreement 0.0036 percentage points.** The exhibit rounds to 0.01, so
0.005 is the floor a reader can check against.

Published Class A-2 weighted average life at this speed: 0.21 years.
