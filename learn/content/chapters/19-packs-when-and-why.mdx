...
**Statements and metrics.** Contracts declare what cash *is*: this stream is base rent, that one is debt service. So the pack can categorize, subtotal, and derive. NOI, DSCR, and EBITDA arrive in results as named metrics with lineage, and output organizes as the domain's statement rather than a flat list of streams. This is what your packless models' hand-designed name taxonomy was approximating; the pack makes it structural.
