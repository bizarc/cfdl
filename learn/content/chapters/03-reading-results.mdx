...
3. Change the retainer amount to `round_to(30000 / 7, 2) * 7` (a contrived per-diem-style calculation). Look at what one period actually pays, and explain where the pennies went — you have just performed, in miniature, every rounding reconciliation you will ever do.
