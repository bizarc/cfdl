...
2. Add a second event that *reverses* nothing, by trying to write a "de-refinance." The latch means the model refuses to express regime flapping. Write down, in one sentence, why that refusal is a feature in a reviewed model.
