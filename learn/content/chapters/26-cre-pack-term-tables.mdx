...
**`cre.ops_revenue`** → `cre.ops.revenue` (operating.revenue.other, inflow); **`cre.opex_line`** → `cre.opex.line` (operating.expense.opex, outflow). Flat amount per period over the term.
