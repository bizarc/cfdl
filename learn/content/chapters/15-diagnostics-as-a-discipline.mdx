...
5. **When you and a colleague disagree, exchange the model hash and the seed.** If the hashes match and the numbers differ, the difference is configuration. The conversation is now about a small JSON file, not about trust.
