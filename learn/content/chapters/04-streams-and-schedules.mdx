...
`on day 31` in a run of months that includes February is not clamped for you. That is what `on eom` is for. The distinction is deliberate: "the 31st" and "month-end" are different contractual claims, and only one of them exists in February.
