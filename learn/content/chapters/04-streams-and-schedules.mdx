...
2. Build a four-payment annual stream three ways — default, `due`, `mid` — at a 10% discount rate, and rank the three NPVs before running. You are re-deriving the annuity-due relationship, and the engine will grade you.
