...
export function CodeActions({
  ...
  // Inlined at build time, so server and client render the same href. Empty
  // on cfdl.dev itself; a sibling app (learn.cfdl.dev) sets it to point its
  // "Open in playground" links back at the site's playground.
  const playgroundOrigin = process.env.NEXT_PUBLIC_PLAYGROUND_ORIGIN ?? "";
