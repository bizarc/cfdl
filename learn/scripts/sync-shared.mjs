...
const MANIFEST = [
  ...
  "lib/playground/cfdl-monarch.ts",
  "lib/playground/client.ts",
  "lib/playground/engine.worker.ts",
  "lib/playground/results.ts",
  "lib/playground/export.ts",
  "components/playground/EditorPane.tsx",
  "components/playground/useEngine.ts",
  "components/playground/ResultsPanel.tsx",
  "components/playground/ExpandOverlay.tsx",
  "components/playground/JsonTree.tsx",
  "components/playground/EnginePrefetch.tsx",
  "components/playground/charts/CashFlowChart.tsx",
  "components/playground/charts/Distribution.tsx",
  "components/playground/charts/LineChart.tsx",
