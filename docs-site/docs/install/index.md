...
|---|---|---|
| Try the language right now | [Playground](/playground) | [none](/install/playground) |
| Model in files, run in CI | CLI | [Install the CLI](/install/cli) |
| Analyze results in pandas / notebooks | Python SDK | [Install for Python](/install/python) |
| Call CFDL from another service | API server | [Run the server](/install/api-server) |
| Author models with diagnostics + hover | VS Code + LSP | [VS Code and LSP](/install/vscode) |
