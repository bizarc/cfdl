...
id: cre-examples
title: "CRE Examples"
slug: "/examples/cre-examples"
---

Commercial Real Estate (CRE) examples show construction → lease-up → stabilized lifecycle, NOI, exit cap rate, and optional construction-to-permanent financing. All use the CRE pack (`use pack "cre"`).
...
- **Pack contracts:** `cre_construction_stub`, `cre_lease`, `cre_ops_revenue`, `cre_ops_expense`, `cre_exit_cap` — see [Packs](/packs) and [CRE pack README](https://github.com/bizarc/cfdl/blob/main/packs/cre/README.md).
