...
This example shows a slightly larger pack-enabled model using pack **contracts** for revenue and opex. In real models, individual revenue/opex items are often modeled as **streams**; see [When to use streams vs contracts](/language-guide#when-to-use-streams-vs-contracts).
