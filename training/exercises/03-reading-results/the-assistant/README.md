...
Prediction before run is the habit: a wrong model is cheapest to catch while your own expectation is still fresh. If the run surprises you, use the four-step descent from the chapter: streams, periods, run settings, then the model.
